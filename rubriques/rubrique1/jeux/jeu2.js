...
lettreAide = () => {
    if (prenom.value.length < pixName.length) {
        // ne pas faire clignoter la lettre suivante quand on arrive Ã  la derniÃ¨re!
...
let aideIt = 0; //itÃ©ation de la variable
    ...
    for (let i = 0; i < buttons.length; i++) {
        function buttonsOnclick() {
            ...
            if (
                ...
                //si rÃ©ponse juste : remise des boutons clavier Ã  zero
                for (let k = 0; k < buttons.length; k++) {
                    buttons[k].style.backgroundColor = "#eae";
                    buttons[k].classList.remove("shake");
                    buttons[k].classList.remove("lettreBlink", "rotateIn");
                }
                //la lettre correcte tourne en vert = rotateIn, et mise Ã  zero de l'aide et des fautes
            ...
            if (prenom.value.length === pixName.length) {
                // si inferieur Ã  4 simple smileys Ã  la place des touches
                ...
                if (jeu1.victoires < listePix.length - 1) {
                    if (sansAide == true) {
                        ...
                        tAide = 9000;
                        console.log("mot Ã©crit avec aide !!")
                        setTimeout(suivant, 2000);
                    }
                }
                // sinon afficher l'anim de victoire finale
                    ...
                    if (sansAide == true) {
                        ...
                        setTimeout(toutEffacer, 3000); // == "bravo tu as gagnÃ©Ã©Ã©"
